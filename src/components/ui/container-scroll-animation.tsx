...
export const ContainerScroll = ({
    ...
    return (
        <div className='w-full h-[80rem] flex items-center justify-center relative p-20' ref={containerRef}>
            <div
    ...
    return (
        <motion.div
            style={{
                ...
                scale,
                boxShadow:
                    '0 0 #ffffffa, 0 9px 20px #fffffffa, 0 37px 37px #ffffffa, 0 84px 50px #fffffff26, 0 149px 60px #fffffffa, 0 233px 65px #fffffff3',
            }}
            ...
            <div className='bg-gray-100 h-full w-full rounded-2xl grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 overflow-hidden p-4'>
                {users.map((user, idx: number) => (
                    <motion.div
                        ...
                        whileHover={{
                            boxShadow: '0 20px 25px -5px rgb(255 255 255 / 0.1), 0 8px 10px -6px rgb(255 255 255 / 0.1)',
                        }}
                    >
